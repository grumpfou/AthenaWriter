...
class TFConstantsAbstract (CMConstantsAbstarct):
	all_constants=dict(	
				...
				DEFAULT_STYLE	= ( TFStyleAttributes,
						TFStyleAttributes({	"font_size":"20",
											"font_name":"Times",
											"alignment":"justify"
											}), 
				...
				EMPHASIZE_STYLE	= (TFStyleAttributes,
						TFStyleAttributes({"char_style":"italic"}), 
						"The style of the emphasize style (for the "+\
							"different options see TEFormatClass description)",
						),
				
				HEADER1_STYLE = (TFStyleAttributes,
						TFStyleAttributes({	"char_style":"bold",
											"font_size":"30",
											"alignment":"center"
											}),
				...
				HEADER2_STYLE = (TFStyleAttributes,
						TFStyleAttributes({	"char_style":"bold",
											"font_size":"25"
											}),
				...
				HEADER3_STYLE = (TFStyleAttributes,
						TFStyleAttributes({	"char_style":"bold",
											"font_size":"20"
											}),
				...
				SEPARATOR_STYLE	= (TFStyleAttributes,
						TFStyleAttributes({"alignment":"center"}), 
